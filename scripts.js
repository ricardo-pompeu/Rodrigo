...
document.addEventListener('DOMContentLoaded', () => {
    const toggleThemeButton = document.getElementById('toggle-theme1');
    const body = document.body;
...
document.addEventListener('DOMContentLoaded', () => {
    const toggleThemeButton = document.getElementById('toggle-thema2');
    const body = document.body;
...
window.addEventListener('scroll', function() {
    ...
    navLinks.forEach(link => {
        ...
        const texts = ["Administração", "Planejamento", "Empreendedorismo", "Gestão", "Marketing", "Inovação" ];
        let index = 0;
        let charIndex = 0;
